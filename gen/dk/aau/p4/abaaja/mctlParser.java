...
public class mctlParser extends Parser {
	...
	public static final int
		...
		Boolean=30, Struct=31, True=32, False=33, And=34, Or=35, Stop=36, Return=37, 
		To=38, Variable=39, If=40, Else=41, Repeat=42, STRUCTID=43, ID=44, NUMBER=45;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"True", "False", "And", "Or", "Stop", "Return", "To", "Variable", "If", 
			"Else", "Repeat", "STRUCTID", "ID", "NUMBER"
		};
	}
	...
	public final MctlContext mctl() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & 24122717372420L) != 0) {
				{
				{
				setState(66);
				line();
	...
	public final InvokeContext invoke() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (((_la) & ~0x3f) == 0 && ((1L << _la) & 52789518712832L) != 0) {
				{
				setState(189);
				actualParameters();
				}
