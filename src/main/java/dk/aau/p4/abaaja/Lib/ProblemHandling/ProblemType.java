...
public enum ProblemType {
    ...
    ERROR_UNEXPECTED_STOP("ERROR_UNEXPECTED_STOP"),
    ERROR_VARIABLE_NOT_INSTANTIATED("ERROR_VARIABLE_NOT_INSTANTIATED"),
    ERROR_TYPE_CANNOT_BE_CAST("ERROR_TYPE_CANNOT_BE_CAST"),
    WARNING_REDUNDANT_TYPECAST("WARNING_REDUNDANT_TYPECAST");
